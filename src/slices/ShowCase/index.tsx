...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    ...
    >
      ...
      <div className="mt-16 grid items-center gap-8 rounded-xl border shadow-2xl border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-8 py-8 backdrop-blur-sm lg:grid-cols-3 lg:gap-0 lg:py-12">
        <div>
        ...
        <PrismicNextImage
          ...
          className={clsx(
            "opacity-90 shadow-md lg:col-span-2  lg:pt-0",
